...
export function usePreviewConversion(params) {
    return useQuery({
        ...
        queryFn: () =>
            analyticsAPI.getPreviewConversion(params).then((r) => r.data),
        staleTime: 60_000,
    });
}
...
export function useAgentRegistrations(params) {
    return useQuery({
        ...
        queryFn: () =>
            analyticsAPI.getAgentRegistrations(params).then((r) => r.data),
        staleTime: 60_000,
    });
}
...
export function useReferralVolume(params) {
    return useQuery({
        ...
        queryFn: () =>
            analyticsAPI.getReferralVolume(params).then((r) => r.data),
        staleTime: 60_000,
    });
}
...
export function useReferralLeaderboard(params) {
    return useQuery({
        ...
        queryFn: () =>
            analyticsAPI.getReferralLeaderboard(params).then((r) => r.data),
        staleTime: 60_000,
    });
}
...
export function useNetworkChains(params) {
    return useQuery({
        ...
        queryFn: () =>
            analyticsAPI.getNetworkChains(params).then((r) => r.data),
        staleTime: 30_000,
    });
}
...
export function useSendAgentInvite() {
    ...
    return useMutation({
        mutationFn: (id) =>
            analyticsAPI.sendAgentInvite(id).then((r) => r.data),
        onSuccess: () => {
            ...
            window.dispatchEvent(
                new CustomEvent('kovera:toast', {
                    detail: {
                        type: 'success',
                        title: 'Invite Sent',
                        message: 'Onboarding invitation sent to agent.',
                    },
                }),
            );
        },
...
export function useApproveAgentRequest() {
    ...
    return useMutation({
        mutationFn: (id) =>
            analyticsAPI.approveAgentRequest(id).then((r) => r.data),
        onSuccess: () => {
            queryClient.invalidateQueries({
                queryKey: ['analytics', 'agent-requests'],
            });
            queryClient.invalidateQueries({
                queryKey: ['analytics', 'network-chains'],
            });
            window.dispatchEvent(
                new CustomEvent('kovera:toast', {
                    detail: {
            ...
            window.dispatchEvent(
                new CustomEvent('kovera:toast', {
                    detail: {
                        type: 'error',
                        title: 'Error',
                        message: 'Failed to approve agent request.',
                    },
                }),
            );
        },
...
export function useRejectAgentRequest() {
    ...
    return useMutation({
        mutationFn: (id) =>
            analyticsAPI.rejectAgentRequest(id).then((r) => r.data),
        onSuccess: () => {
            queryClient.invalidateQueries({
                queryKey: ['analytics', 'agent-requests'],
            });
            window.dispatchEvent(
                new CustomEvent('kovera:toast', {
                    detail: {
                        type: 'success',
                        title: 'Rejected',
                        message: 'Agent request has been rejected.',
                    },
                }),
            );
        },
            ...
            window.dispatchEvent(
                new CustomEvent('kovera:toast', {
                    detail: {
                        type: 'error',
                        title: 'Error',
                        message: 'Failed to reject agent request.',
                    },
                }),
            );
        },
            ...
            window.dispatchEvent(
                new CustomEvent('kovera:toast', {
                    detail: {
                        ...
                        message: `Invitation sent to ${agentEmail}.`,
                    },
                }),
            );
        },
...
export function useUsersList({ page = 1, limit = 20, search = '' } = {}) {
    return useQuery({
        queryKey: ['admin', 'users-list', page, limit, search],
        queryFn: () =>
            analyticsAPI.getUsersList({ page, limit, search }).then((r) => r.data),
        staleTime: 30_000,
        keepPreviousData: true,
    });
}

export function useAgentsList({ page = 1, limit = 20, search = '' } = {}) {
    return useQuery({
        queryKey: ['admin', 'agents-list', page, limit, search],
        queryFn: () =>
            analyticsAPI.getAgentsList({ page, limit, search }).then((r) => r.data),
        staleTime: 30_000,
        keepPreviousData: true,
    });
}
