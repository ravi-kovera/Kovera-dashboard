...
} from '@/services/hooks/useProperties';
                    ...
                    <>
                        ...
                        <div className="relative h-56 sm:h-64 bg-navy-950 overflow-hidden">
                            <img
                                src={
                                    prop.images?.[imgIdx] ||
                                    `https://picsum.photos/seed/${prop.id}/600/400`
                                }
                                alt={prop.title}
                            ...
                            <div className="absolute top-4 right-4 flex items-center gap-2">
                                <Badge variant={STATUS_VARIANT[prop.status]}>
                                    {prop.status}
                                </Badge>
                            ...
                            <button
                                onClick={onClose}
                                className="absolute top-4 right-4 mt-8 p-2 rounded-xl bg-navy-950/60 text-white hover:bg-navy-950/80 transition-colors cursor-pointer"
                            >
                                <X className="w-4 h-4" />
                            </button>
                        </div>
                                    ...
                                    {prop.likedBy?.length > 0 ? (
                                        <div className="space-y-2">
                                            {prop.likedBy.map((u) => (
                                                <div
                                                    key={u.id}
                                                    className="flex items-center gap-3 p-3 rounded-xl bg-navy-950 border border-border"
                                                >
        ...
        >
            ...
            <div className="p-4">
                ...
                <div className="flex items-center gap-3 mt-3 pt-3 border-t border-border text-xs text-muted">
                    ...
                    <span className="flex items-center gap-1">
                        <Maximize2 className="w-3 h-3" /> {property.sqft}
                    </span>
                    <Badge
                        variant="outline"
                                        ...
                                        >
                                            <td className="px-5 py-3.5">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <span className="text-sm font-medium text-white group-hover:text-primary-light transition-colors truncate max-w-[200px]">
                                                        {prop.title}
                                                    </span>
                                                </div>
                                            </td>
