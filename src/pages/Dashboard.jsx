    ...
    const kpiCards = useMemo(() => {
        ...
        return [
            ...
            },
            {
                key: 'totalAgents',
                title: 'Total Agents',
                value: fmtNum(dash.totalAgents),
                change: fmtPct(pc.newAgents?.changePct),
                trend: (pc.newAgents?.changePct || 0) >= 0 ? 'up' : 'down',
                icon: UserCog,
                accentColor: 'purple',
            },
            {
                ...
                value: fmtNum(dash.totalListings),
                change: null,
                trend: 'up',
                icon: Building2,
                accentColor: 'green',
            },
            {
                key: 'totalChains',
                title: 'Chains',
                value: fmtNum(dash.totalChains),
                change: fmtPct(pc.newChains?.changePct),
                trend: (pc.newChains?.changePct || 0) >= 0 ? 'up' : 'down',
                icon: Link2,
                accentColor: 'amber',
            },
            {
                key: 'totalReferrals',
                title: 'Referrals',
                value: fmtNum(dash.totalReferrals),
                change: fmtPct(pc.newReferrals?.changePct),
                trend: (pc.newReferrals?.changePct || 0) >= 0 ? 'up' : 'down',
                icon: Share2,
                accentColor: 'cyan',
            },
            {
                key: 'impressions',
                title: 'Impressions',
                value: fmtNum(pc.impressions?.current),
                change: fmtPct(pc.impressions?.changePct),
                trend: (pc.impressions?.changePct || 0) >= 0 ? 'up' : 'down',
                icon: Eye,
                accentColor: 'red',
            },
        ];
                ...
                <Card className="lg:col-span-2">
                    <CardHeader>
                        <CardTitle className="flex items-center gap-2">
                            <TrendingUp className="w-4 h-4 text-primary" /> User
                            Signups
                        </CardTitle>
                    </CardHeader>
                    <CardContent>
          ...
          ══════════════════════════════════════════ */}
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <Card>
                    <CardHeader>
                        <CardTitle className="flex items-center gap-2">
                            <UserCheck className="w-4 h-4 text-primary" /> User
                            Activity
                        </CardTitle>
                    </CardHeader>
                    <CardContent>
                        {activityQ.isLoading ? (
                            ...
                            <EmptyState
                                variant={activityQ.isError ? 'error' : 'empty'}
                            ...
                            <>
                                ...
                                <div className="grid grid-cols-3 gap-3 mt-3">
                                    {activityPie.map((item) => (
                                        <div
                                            key={item.name}
                                            className="text-center p-2 rounded-xl bg-navy-950 border border-border"
                                        >
                                            <div
                ...
                <Card>
                    ...
                    <CardContent className="space-y-4">
                        {swipeQ.isLoading ? (
                            ...
                            <EmptyState
                                variant={swipeQ.isError ? 'error' : 'empty'}
                                onRetry={swipeQ.refetch}
                            />
                        ) : (
                            swipe && (
                                <>
                                    <div className="space-y-3">
                                        {[
                                            ...
                                            <div
                                                key={item.label}
                                                className="flex items-center justify-between p-3 rounded-xl bg-navy-950 border border-border"
                                            >
                ...
                <Card className="lg:col-span-2">
                    ...
                    <CardContent>
                        {listingsQ.isLoading ? (
                            ...
                            <EmptyState
                                variant={listingsQ.isError ? 'error' : 'empty'}
